...
1.  Clone the repository:
    ...
    ```
2.  **Important Note**: This project uses the `fetch()` API to load login data from a JSON file. Therefore, the login functionality will not work if you simply double-click `acasa.html` to open it from your file explorer. You must run it through a local server.
...
3.  The easiest way to view the project is using the **Live Server** extension in Visual Studio Code:
    ...
    * Right-click on the `acasa.html` file in your Explorer sidebar.
